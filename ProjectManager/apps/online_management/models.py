...
class TroubleRecord(models.Model):
    ...
    url = models.ForeignKey(DomainNameResolveInfo, verbose_name='域名', related_name='tr_url', blank=True, null=True,
    ...
    handle_result = models.PositiveSmallIntegerField(verbose_name='处理结果', choices=((1, '已处理'), (2, '未处理'), (3, '其它')),
                                                     default=1)
...
class DeployRecord(models.Model):
    name = models.CharField(verbose_name='平台名称', max_length=20)
    url = models.ForeignKey(DomainNameResolveInfo, verbose_name='域名', related_name='dep_url', blank=True, null=True,
                            on_delete=models.CASCADE)
