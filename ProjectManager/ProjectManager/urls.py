...
from ProjectManager.settings import MEDIA_ROOT
...
# 错误页面
handler403 = 'usr.views.permission_denied'
handler404 = 'usr.views.page_not_found'
handler500 = 'usr.views.page_error'
